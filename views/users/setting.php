		...
		<section class="content">
			<div class="row">				
				<div class="col-12">
					...
					<!--			</div>-->
					<!--			<a href="<?php // url_view_builder('user/requestPasswordReset') ?>" class="btn btn-info">Change Password</a>-->
					<!--		</div>-->
					<!--	</div>-->
					<!--</div>-->
						...
						<div class="box-body p-0">
							<div class="table-responsive">
							  <table class="table mb-0">
								  ...
								  <tbody>
									<?php
									if (isset($data['logs']) && is_array($data['logs']) && count($data['logs']) > 0) {
										foreach($data['logs'] as $log):
										$user_agent = explode(' ' , $log->user_agent);
									?>
									<tr>
									  <th scope="row"><?= $user_agent[0] ?></th>
									  <td><?= $log->ip_address ?></td>
									  <td><?= $log->created_at ?></td>
									  <td><a href="<?= url_view_builder('user/deleteActivityLogSetting/' . $log->id); ?>" class="text-danger"><i class="fa fa-trash"></i></a></td>
									</tr>
							<?php
endforeach;
									}
