	  ...
	  <div class="container-full">
		...
		<section class="content">
		  ...
		  <div class="row gy-12">
			  ...
			  <div class="col-12">
				  <div class="row row-cols-lg-12 row-cols-1 g-12">				  
					...
					<div class="col-12">
					  <div class="box mb-0">
						...
						<div class="box-body">
            <?php
  if($data['notif'] != null && isset($data['notif'])):
          foreach($data['notif'] as $notif):

            ?>
						  <div class="alert alert-<?= $notif->status == 'ban' ? 'danger' : 'warning' ?> alert-dismissible">
							<a href="<?= url_view_builder('estate/readNotification/' . $notif->id) ?>" class="btn-close" aria-label="Close"></a>
							<h4><i class="icon fa fa-<?= $notif->status ?>"></i></h4>
              <?= $notif->message ?>
						  </div>
<?php
...
<!-- ./wrapper -->
	...
	<script src="../src/js/pages/toastr.js"></script>
    <script src="../src/js/pages/notification.js"></script>
	<?php
