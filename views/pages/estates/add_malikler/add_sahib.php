		 ...
		 <!-- Step wizard -->
		  <div class="box">
			...
			<div class="box-body wizard-content">
				<form action="<?= url_view_builder('estate/ekle') ?>" class="tab-wizard wizard-circle" method="post">
					<!-- Step 1 -->
						...
						<div class="row">
							...
							<div class="col-md-3">
								...
								<label class="form-label">Sonuç :</label>
									<div class="c-inputs-stacked">
										<input type="checkbox" id="checkbox_305" name="soldـout" <?= old_checkbox($data, 'soldـout') ?>>
										<label for="checkbox_305" class="d-block">Satmış</label>
										<input type="checkbox" id="checkbox_245" name="rented" <?= old_checkbox($data, 'rented') ?>>
										<label for="checkbox_245" class="d-block">Kiralamış</label>
										<input type="checkbox" id="checkbox_306" name="wrong_number" <?= old_checkbox($data, 'wrong_number') ?>>
										<label for="checkbox_306" class="d-block">Yanlış No</label>
										<input type="checkbox" id="checkbox_256" name="did_not_answer" <?= old_checkbox($data, 'did_not_answer') ?>>
										<label for="checkbox_256" class="d-block">Cevap yok</label>
										<input type="checkbox" id="checkbox_267" name="does_not_sell" <?= old_checkbox($data, 'does_not_sell') ?>>
										<label for="checkbox_267" class="d-block">Satmak istemiyor</label>
										<input type="checkbox" id="checkbox_278" name="not_available" <?= old_checkbox($data, 'not_available') ?>>
										<label for="checkbox_278" class="d-block">Ulaşılamıyor</label>
										<input type="checkbox" id="checkbox_289" name="do_not_disturb" <?= old_checkbox($data, 'do_not_disturb') ?>>
										<label for="checkbox_289" class="d-block">Aranmak istemiyor</label>
										<input type="checkbox" id="checkbox_301" name="sale" <?= old_checkbox($data, 'sale') ?>>
										<label for="checkbox_301" class="d-block">Satmak istiyor</label>
										<input type="checkbox" id="checkbox_302" name="not_sale" <?= old_checkbox($data, 'not_sale') ?>>
										<label for="checkbox_302" class="d-block">satmak istemiyor</label>
										<input type="checkbox" id="checkbox_303" name="rent" <?= old_checkbox($data, 'rent') ?>>
										<label for="checkbox_303" class="d-block">Kira vermek istiyor</label>
										<input type="checkbox" id="checkbox_304" name="not_rent" <?= old_checkbox($data, 'not_rent') ?>>
										<label for="checkbox_304" class="d-block">kira vermek istemiyor</label>
									</div>
								</div>
							</div>
							<div class="col-md-3">
								<div class="form-group">
								   <label class="form-label">Tavsiye :</label>
									<div class="c-inputs-stacked">
										<input type="checkbox" id="checkbox_307" name="opportunity" value="yes" onclick="checkOnlyThis(this , 'opportunity')">
										<label for="checkbox_307" class="d-block">Evet</label>
										<input type="checkbox" id="checkbox_308" name="opportunity" value="no" onclick="checkOnlyThis(this , 'opportunity')">
										<label for="checkbox_308" class="d-block">Hayır</label>
									</div>
								</div>
							</div>
