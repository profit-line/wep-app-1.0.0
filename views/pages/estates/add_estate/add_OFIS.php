				...
				<section class="content">
					...
					<div class="box">
						...
						<div class="box-body wizard-content">
							<form action="<?= url_view_builder('estate/addOfis') ?>" class="tab-wizard wizard-circle" method="post">
								<!-- Step 1 -->
											...
											<div class="form-group">
												...
												<select class="form-select <?= add_class_error($data, 'city'); ?>" id="location3" name="city">
													...
													<?php foreach ($data['cities'] as $city => $value): ?>
														<option value="<?= $city ?>" <?= (isset($data['requests']['city']) && $data['requests']['city'] == $city) ? 'selected' : '' ?>><?= $value ?></option>
													<?php endforeach; ?>
												</select>
