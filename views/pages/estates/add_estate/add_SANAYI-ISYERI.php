		 ...
		 <!-- Step wizard -->
		  <div class="box">
			...
			<div class="box-body wizard-content">
				<form action="<?= url_view_builder('estate/addSanayiIsyeri') ?>" class="tab-wizard wizard-circle" method="post">
					<!-- Step 1 -->
					...
					<section>
						...
						<div class="row">
							<div class="col-md-2">
							<div class="form-group">
												<label for="floor_count" class="form-label"> Kat sayısı :</label>
												<input type="text" class="form-control <?= add_class_error($data, 'floor_count'); ?>" name="floor_count" id="floor_count" value="<?= old($data, 'multiـstorey') ?>">
